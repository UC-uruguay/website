#!/usr/bin/env python3
"""
Homepage template with correct footer (no separator bar, no "With Love from UC")
"""
...
print("🎨 Creating homepage template with correct footer...")

# Homepage content with CORRECT footer (no separator, no "With Love from UC")
correct_homepage_content = '''<!-- wp:html -->
<style>
...
try:
    # Update homepage with correct footer
    page_data = {
        "content": correct_homepage_content,
        "status": "publish"
    }
    ...
    print("\n🎉 Homepage updated with correct footer!")
    print("✅ REMOVED: Separator bar (hr)")
    print("✅ REMOVED: 'With Love from UC ❤️' text")
    print("✅ Footer now ends with SNS icons only")
    print("✅ Temple Visits links to article")
    print("✅ All other content preserved")
    print("✅ Rule saved to SITE_RULES.md permanently")
...
print(f"\n📋 PERMANENT footer rules now in effect:")
print("• No separator line before SNS icons")
print("• No 'With Love from UC ❤️' text")
print("• Footer ends with SNS icons only")
print("• This will be maintained in all future updates")