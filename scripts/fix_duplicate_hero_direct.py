#!/usr/bin/env python3
"""
Fix duplicate hero sections by checking content directly
"""
...
print("🔧 Fixing duplicate hero sections...")
...
<!-- wp:image {{"id":{media_id},"width":"280px","height":"280px","scale":"cover","style":{{"border":{{"radius":"50%"}}}}}} -->
<figure class="wp-block-image is-resized has-custom-border">
<img src="{image_url}" alt="UC Profile Photo" class="wp-image-{media_id}" style="border-radius:50%;object-fit:cover;width:280px;height:280px"/>
</figure>
<!-- /wp:image -->
...
<!-- /wp:group -->'''
    ...
    print("✅ Page rebuilt with single hero section!")
    print(f"🌐 Updated site: {result['link']}")
else:
    print("✅ Only one hero section found, no changes needed")

print("🎯 Homepage now has exactly one hero section with 'Hi, I'm UC! 👋'")