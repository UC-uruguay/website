#!/usr/bin/env python3
"""
Create homepage with correct family names: wife=Haruhi, son=Ichiyu
"""
...
print("👨‍👩‍👦 Creating homepage with correct family names...")

# Corrected homepage content with proper family names
correct_content = '''<!-- wp:group {"align":"full","style":{"spacing":{"padding":{"top":"80px","bottom":"80px","left":"20px","right":"20px"}},"color":{"background":"#f8f9fa"}},"className":"hero-section"} -->
...
try:
    # Update the page with correct family names
    page_data = {
    ...
    print("\n🎉 Homepage updated with correct family names!")
    print("✅ Wife: Haruhi")
    print("✅ Son: Ichiyu")
    print("✅ Updated both About Me text and Family time mention")
    print("✅ Information saved to SITE_RULES.md permanently")
...
print(f"\n📋 Corrected family information:")
print("• Main text: 'my wonderful wife Haruhi and our son Ichiyu'")
print("• Family time: 'with Haruhi and Ichiyu'") 
print("• SITE_RULES.md: Wife=Haruhi, Son=Ichiyu (permanent record)")
print("• No more nicknames or incorrect combinations")