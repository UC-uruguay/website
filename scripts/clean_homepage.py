#!/usr/bin/env python3
"""
Clean homepage - rebuild with single hero section
"""
...
print("🧹 Cleaning homepage and rebuilding with single hero section...")

# Build complete content piece by piece
hero_section = '''<!-- wp:cover {"url":"https://uc.x0.com/wp-content/uploads/2025/08/uc-profile.jpg","id":10,"dimRatio":30,"overlayColor":"black","minHeight":60,"minHeightUnit":"vh","align":"full"} -->
...
complete_content = hero_section + about_section + remaining_sections
...
print("✅ Homepage cleaned and rebuilt successfully!")
print(f"🌐 Updated site: {result['link']}")
print("🎯 Now showing exactly one hero section with 'Hi, I'm UC! 👋'")