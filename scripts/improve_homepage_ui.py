#!/usr/bin/env python3
"""
Improve homepage UI by reducing text and updating family info
"""
...
print("✨ Improving homepage UI - reducing text, updating family info...")

# Improved, more concise homepage content
improved_content = '''<!-- wp:group {"align":"full","style":{"spacing":{"padding":{"top":"80px","bottom":"80px","left":"20px","right":"20px"}},"color":{"background":"#f8f9fa"}},"className":"hero-section"} -->
...
<p style="font-size:clamp(1rem, 2.5vw, 1.1rem);line-height:1.7">Hi, I'm <strong>Yushi Nakashima</strong>, but everyone calls me <strong>UC</strong>. I live in Kōfu, Yamanashi with my wonderful wife and our son, <strong>Ichiyu Haruhi Yushi</strong>.</p>
<!-- /wp:paragraph -->
...
<li><strong>Family time</strong> with my amazing wife and son ❤️</li>
...
try:
    ...
    print("\n🎉 Homepage UI improved successfully!")
    print("✅ Updated family info: Ichiyu Haruhi Yushi (no nickname)")
    print("✅ Reduced text significantly while keeping charm")
    print("✅ Made sections more concise and visually appealing")
    print("✅ Kept UC's personality and warmth")
...
print(f"\n📋 Key improvements:")
print("• Hero section: More concise, still engaging")
print("• About Me: Shorter, focused on essentials")
print("• Family info: Proper name for son (Ichiyu Haruhi Yushi)")
print("• Removed lengthy lists, kept most important points")
print("• Gallery section: Streamlined as 'My World'")
print("• Better responsive typography with clamp()")
print("• Maintained UC's friendly, international personality")
print("• Wife's feedback addressed: Less overwhelming text")