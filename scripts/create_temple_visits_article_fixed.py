...
temple_article_content = '''<!-- wp:paragraph -->
...
if image_id and image_url:
    temple_article_content += f'''

<!-- wp:image {{"id":{image_id},"align":"center","width":"600","height":"450"}} -->
<figure class="wp-block-image aligncenter is-resized">
<img src="{image_url}" alt="UC with Buddhist monk during temple visit" class="wp-image-{image_id}" style="width:600px;height:450px;object-fit:cover"/>
<figcaption class="wp-element-caption">A meaningful encounter with a wise monk during my temple exploration</figcaption>
</figure>
<!-- /wp:image -->'''
