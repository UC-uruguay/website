#!/usr/bin/env python3
"""
Restore complete homepage content with new hero section (no background image)
"""
...
print("🔄 Restoring complete homepage content...")

# Complete content with new hero section and all original sections
complete_content = '''<!-- wp:group {"align":"full","style":{"spacing":{"padding":{"top":"80px","bottom":"80px","left":"20px","right":"20px"}},"color":{"background":"#f8f9fa"}}} -->
...
try:
    # Update the page with complete content
    page_data = {
    ...
    print("✅ Homepage content restored successfully!")
    print("📄 All sections restored:")
    print("  - New hero section (no background image)")
